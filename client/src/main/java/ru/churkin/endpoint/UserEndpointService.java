 ...
 * 2019-03-06T16:03:27.858+03:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "UserEndpointService", 
                  wsdlLocation = "http://localhost:8080/TaskList/user?wsdl",
                  targetNamespace = "http://endpoint.churkin.ru/") 
public class UserEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.churkin.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.churkin.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/TaskList/user?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/TaskList/user?wsdl");
        }
        WSDL_LOCATION = url;
    }
